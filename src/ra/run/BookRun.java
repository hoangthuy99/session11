...
public class BookRun {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    bookRun.inputBook(scanner);
                    break;
                case 2:
                    bookRun.displayBook();
                    break;
                case 3:
                    bookRun.updateBookById(scanner);
                    break;
                case 4:
                    bookRun.deleteBookById(scanner);
                    break;
                case 5:
                    bookRun.sortBookByPrice();
                    break;
                case 6:
                    bookRun.statisticalBookByPrice(scanner);
                    break;
                case 7:
                    bookRun.searchBookByAuthor(scanner);
                    break;
                case 8:
                    System.exit(0);
